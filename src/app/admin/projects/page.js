    ...
    <div className="flex min-h-screen !bg-[#e5e4e1] selection:bg-black selection:text-white">
      ...
      <main className="flex-1 p-8 md:p-12 mt-10 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <div className="space-y-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#a1a1a1] ml-1">
                    Project Title
                  </label>
                  <input
                    name="title"
                    ...
                    className="w-full bg-[#f8f9fa] border border-[#f0f0f0] rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-black/5 text-black"
                    required
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-[#f8f9fa] border border-[#f0f0f0] rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-black/5 text-black"
                    placeholder="https://initcodes.in/project"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#a1a1a1] ml-1">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full bg-[#f8f9fa] border border-[#f0f0f0] rounded-xl py-3 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-black/5 text-black resize-none"
              ...
              <div className="md:col-span-2 pt-4 flex gap-4">
                ...
                {editingId && (
                  <button
                    type="button"
                    onClick={resetForm}
                    className="px-8 border border-black/10 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-black hover:text-white transition-all"
                  >
                    Cancel
                  </button>
                )}
          ...
          {/* REGISTRY TABLE */}
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.02)] border border-white min-h-[400px]">
            <div className="flex justify-between items-center mb-10">
              <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-black opacity-30">
                Active Registry
              </h2>
              ...
              <table className="w-full text-left border-collapse min-w-[600px] md:min-w-full">
                <thead>
                  <tr className="border-b border-black/5">
                    <th className="pb-4 px-2 text-[10px] font-bold uppercase tracking-widest opacity-40">
                      Project / Developer
                    </th>
                    <th className="pb-4 px-2 text-[10px] font-bold uppercase tracking-widest opacity-40">
                      Tags
                    </th>
                    <th className="pb-4 px-2 text-[10px] font-bold uppercase tracking-widest opacity-40 text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
                    ...
                    <tr key={project._id} className="group">
                      <td className="py-6 px-2">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] font-mono opacity-40 uppercase tracking-tighter mt-1">
                            {project.developer}
                          </span>
                        </div>
                      </td>
                      <td className="py-4 px-2">
                        <div className="flex flex-wrap gap-2">
                          {project.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[11px] font-bold uppercase px-2 py-0.5 bg-black/5 border border-black/5 rounded whitespace-nowrap"
                            >
                              {tag}
                            </span>
                          ))}
                      ...
                      <td className="py-6 px-2 text-right">
                        <div className="flex justify-end gap-1 md:gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                          ...
                          <button
                            ...
                            className="p-2 hover:bg-red-500 hover:text-white rounded-lg transition-colors text-red-500/50 md:text-red-500/30"
