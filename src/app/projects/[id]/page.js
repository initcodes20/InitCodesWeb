...
export default async function SingleProjectPage(props) {
  ...
  // Validate ObjectId to prevent production crashes
          ...
          <aside className="lg:col-span-4 space-y-12">
            <div className="p-8 bg-white border-2 border-black rounded-3xl shadow-xl">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-30">
                  Tech_Stack
                </h3>
            ...
            <div className="space-y-4">
              <p className="text-[9px] font-bold uppercase tracking-[0.4em] opacity-30 px-2">
                Access_Point
              </p>
            ...
            <div className="pt-8 border-t border-black/5">
              <div className="space-y-2">
                <p className="text-[9px] font-bold uppercase tracking-[0.4em] opacity-20">
                  Registry_ID: {id.slice(-8).toUpperCase()}
                </p>
                <p className="text-[9px] font-bold uppercase tracking-[0.4em] opacity-20">
                  Architect: {project.author || "InitCodes_Core"}
                </p>
              </div>
            </div>
          </aside>
